...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        setLoading(true);
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(email, password);
        if (result.success) {
            router.push("/");
        } else {
...
//# sourceMappingURL=_864a3285._.js.map