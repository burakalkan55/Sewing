...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(email, password, name);
        if (result.success) {
            router.push("/");
        } else {
...
//# sourceMappingURL=_8e3d6e98._.js.map